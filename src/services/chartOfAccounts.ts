...
export const CHART_OF_ACCOUNTS: AccountDefinition[] = [
  ...
  {
    code: '2200',
    name: 'Customer Credits / Customer Deposits',
    type: 'liability',
    ...
    cashFlowCategory: 'Operating',
    statementGrouping: 'Liabilities',
    description: 'Overpayments, unapplied cash balances, and customer credit deposits.'
  },
  {
    code: '3000',
  ...
  {
    code: '1400',
    name: 'Vendor Prepayments / Deposits',
    type: 'asset',
    ...
    cashFlowCategory: 'Operating',
    statementGrouping: 'Assets',
    description: 'Deposits, down payments, and credit balances held with suppliers.'
  },
  {
    code: '2000',
    ...
    cashFlowCategory: 'Operating',
    statementGrouping: 'Liabilities',
    description: 'Owed to vendors and suppliers for purchases made on credit.'
  },
  {
    code: '2050',
    name: 'Accrued Purchases / GRNI',
    type: 'liability',
    subtype: 'Other Current Liability',
    normalBalance: 'credit',
    active: true,
    ...
    cashFlowCategory: 'Operating',
    statementGrouping: 'Liabilities',
    description: 'Goods Received Not Invoiced - temporary clearing for inventory cost before vendor bill arrives.'
  },
  {
    code: '5100',
    ...
    cashFlowCategory: 'Operating',
    statementGrouping: 'Expense',
    description: 'Cost of inventory and stems consumed to fulfill delivered customer orders.'
  },
  {
    code: '5200',
    ...
    cashFlowCategory: 'Operating',
    statementGrouping: 'Expense',
    description: 'Cost of operating supplies, packaging, ribbons, and store materials.'
  },
  {
    code: '5300',
    name: 'Freight-In',
    ...
    cashFlowCategory: 'Operating',
    statementGrouping: 'Expense',
    description: 'Freight, shipping, and courier transport costs on raw purchases.'
  },
  {
    code: '5400',
  ...
  },
  {
    ...
    cashFlowCategory: 'Operating',
    statementGrouping: 'Expense',
    description: 'Expense incurred for third-party courier dispatch services.'
  },
  {
    code: '2300',
    name: 'Third-Party Courier Payable',
    type: 'liability',
    subtype: 'Accounts Payable',
    normalBalance: 'credit',
    active: true,
    ...
    cashFlowCategory: 'Operating',
    statementGrouping: 'Liabilities',
    description: 'Outstanding amounts owed to third-party couriers (e.g., Uber Direct, DoorDash Drive).'
  },
  {
    code: '2400',
    name: 'Delivery Fee Clearing',
    type: 'liability',
    subtype: 'Other Current Liability',
    normalBalance: 'credit',
    active: true,
    ...
    cashFlowCategory: 'Operating',
    statementGrouping: 'Liabilities',
    description: 'Clearing account for customer delivery fee revenues prior to fulfillment/reconciliation.'
  }
];
